...
class algs:
    def __init__(self, exp='genre', p=0.0, padval=0.0):
        ...
        pd.to_csv(r'D:\Sem 6\EE 6106\6106-Project\preproc\genres\table.csv')
    ...
    def run(self, num_iterations=20, T=5000):
        ...
        avg_egc_regret = self.epsilon_greedy_clr(num_iterations, T)
        ...
        avg_cegc_regret = self.C_epsilon_greedy_clr(num_iterations, T)
        ...
        self.plot_av_egc = np.mean(avg_egc_regret, axis=0)
        ...
        self.plot_av_cegc = np.mean(avg_cegc_regret, axis=0)
        ...
        self.plot_std_egc = np.sqrt(np.var(avg_egc_regret, axis=0))
        ...
        self.plot_std_cegc = np.sqrt(np.var(avg_ceg_regret, axis=0))
    ...
    def plot(self):
        ...
        plt.plot(range(0, 5000)[::spacing], self.plot_av_egc[::spacing], label='EpsilonGreedy_clr', color='magenta', marker='-')
        ...
        plt.plot(range(0, 5000)[::spacing], self.plot_av_cegc[::spacing], label='C_EpsilonGreedy_clr', color='brown', marker='e')
        ...
        plt.fill_between(range(0, 5000)[::spacing], (self.plot_av_egc + self.plot_std_egc)[::spacing],
                         (self.plot_av_eg - self.plot_std_eg)[::spacing], alpha=0.3, facecolor='magenta')
        ...
        plt.fill_between(range(0, 5000)[::spacing], (self.plot_av_cegc + self.plot_std_cegc)[::spacing],
                         (self.plot_av_ceg - self.plot_std_ceg)[::spacing], alpha=0.3, facecolor='brown')
